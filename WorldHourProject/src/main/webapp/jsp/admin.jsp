				...
				<tr>
					...
					<td>
						<div class="edit-del-btns">
							<button class="edit-button" onclick="window.location.href='<%=WHPView.EditCountryPage%>?id=<%=cb.getId() %>'">Edit</button>
							<button class="delete-button" onclick="window.location.href='<%=WHPView.DeleteCountryServlet%>?id=<%=cb.getId() %>'">Delete</button>
						</div>
					</td>
				</tr>
